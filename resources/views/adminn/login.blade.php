	...
	<div class="log-w3">
		<div class="w3layouts-main">
			...
			<form action="{{route('admin.auth')}}" method="post">
				...
				<div class="alert alert-primary alert-dismissible " style="background-color: #8B5C7E; color:white" role="alert">
			...
			<p>Don't Have an Account ?<a href="{{asset('registration.html')}}">Create an account</a></p>
		</div>
	</div>
