...
<body style="font-family: Georgia, 'Times New Roman', Times, serif; font-weight: 20px;">
            ...
            <input type="text" class="form-control search" placeholder=" Search">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu extended logout">
                            ...
                            <li><a href="{{url('manager/manager/logout')}}"><i class="fa fa-key"></i> Log Out</a>
                ...
                <div class="leftside-navigation" style="font-size: 50%;">
                    <ul class="sidebar-menu" id="nav-accordion">
                        <li>
                         ...
                         <li>
                             <a href="{{route('admin.addmanager.index')}}">
                                <i class="fa fa-book"></i>
                                <span>Manager</span>
                            </a> 
                        </li>
                        <li> 
                            <a href="{{route('admin.category_index_admin')}}">
                        ...
                        <li>
                            <a href="{{route('admin.subcategory_index_admin')}}">
                                <i class="fa fa-list"></i>
                                <span>View SubCategory</span>
                            </a>
                        </li>
                        <li class="sub-menu">
                            <a href="{{route('admin.product_index_admin')}}">
                        ...
                        <li>
                            <a href="{{route('admin.offer_index_admin')}}">
                                <i class="fa fa-list"></i>
