    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu extended logout">
                ...
                <li><a href="{{asset('login.html')}}"><i class="fa fa-key"></i> Log Out</a></li>
            </ul>
        </li>
            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						...
						<li><a href="{{asset('glyphicon.html')}}">glyphicon</a></li>
                        <li><a href="{{asset('grids.html')}}">Grids</a></li>
                    </ul>
                </li>
                <li>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        ...
                        <li><a href="{{asset('responsive_table.html')}}">Responsive Table</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="{{asset('javascript:;')}}">
                    ...
                    <ul class="sub">
                        <li><a href="{{asset('form_component.html')}}">Form Elements</a></li>
                        <li><a href="{{asset('form_validation.html')}}">Form Validation</a></li>
						<li><a href="{{asset('dropzone.html')}}">Dropzone</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="{{asset('javascript:;')}}">
