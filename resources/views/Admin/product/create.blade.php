    ...
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-6">
                        <p class="card-title" style="padding-left: 8px;"><b>ADD PRODUCT</b></p>
                    </div>
                ...
                <form class="forms-sample" action="{{route('Admin.product.store')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputName1" name="product_name" required>
                    </div>
                    <div class="form-group">
                        <!-- <label>image</label> -->
                    ...
                    <!-- <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputName1" name="brand" required>
                    </div> -->
                    <div class="form-group">
                        <label for="exampleInputName1">Short Description</label>
                        <input type="text" class="form-control" id="exampleInputName1" name="short_description" required>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputName1">product Description</label>
                        <input type="text" class="form-control" id="exampleInputName1" name="product_discription" required>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputName1">product cost</label>
                        <input type="text" class="form-control" id="exampleInputName1" name="product_cost" required>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputName1">QOH</label>
                        <input type="text" class="form-control" id="exampleInputName1" name="QOH" required>
                    </div>
...
<!-- 
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputName1" name="keywords" required>
                    </div> -->
<!-- 
                        ...
                        <div class="row"> -->
                            ...
                            <!-- <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputName1" name="lead_time" required>
                                </div>
                            </div> -->
...
<!-- 
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputName1" name="tax" required>
                                </div>
                            </div> -->
...
<!-- 
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputName1" name="tax_type" required>
                                </div>
                            </div>
                        </div> -->
