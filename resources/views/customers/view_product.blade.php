                        ...
                        <div class="product-toys-info">
                            <div class="men-pro-item">
                                <div class="men-thumb-item">
                                    ...
                                    <img src="{{url('product')}}/{{$data->image}}" class="img-thumbnail img-fluid" alt="">
                                    <div class="men-cart-pro">
                                        <div class="inner-men-cart-pro">
                                            <a href="{{route('customers.view_product_details')}}/{{$data->id}}" class="link-product-add-cart">VIEW DETAIL</a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="info-product-price">
                                        <div class="grid_meta">
                                            <div class="product_price">
                                                <h4>
                                                    <a href="single.html">{{$data->product_name}}</a>
                                                </h4>
                                                <div class="grid-price mt-2">
                                                    <span class="money ">${{$data->product_cost}}</span>
                                                </div>
                                            </div>
                                            <ul class="stars">
                                                <li>
