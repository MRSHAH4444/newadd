...
<html lang="zxx">
   <head>
      ...
      <!--//meta tags ends here-->
      <!--booststrap-->
      <link href="{{asset('customers/css/bootstrap.min.css')}}" rel="stylesheet" type="text/css" media="all">
      <!--//booststrap end-->
      <!-- font-awesome icons -->
      <link href="{{asset('customers/css/fontawesome-all.min.css')}}" rel="stylesheet" type="text/css" media="all">
      <!-- //font-awesome icons -->
      <!--Shoping cart-->
      <link rel="stylesheet" href="{{asset('customers/css/shop.css')}}" type="text/css" />
      <!--//Shoping cart-->
      <!--price range-->
      <link rel="stylesheet" type="text/css" href="{{asset('customers/css/jquery-ui1.css')}}">
      <!--//price range-->
      <!--stylesheets-->
      <link href="{{asset('customers/css/style.css')}}" rel='stylesheet' type='text/css' media="all">
      <!--//stylesheets-->
